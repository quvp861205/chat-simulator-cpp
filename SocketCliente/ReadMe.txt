========================================================================
    APLICACIÓN DE CONSOLA: SocketCliente Información general 
    del proyecto
========================================================================

AppWizard ha creado esta aplicación SocketCliente.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la SocketCliente aplicación.


SocketCliente.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado SocketCliente.pch y un archivo de 
