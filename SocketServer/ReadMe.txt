========================================================================
    APLICACIÓN DE CONSOLA: SocketServer Información general 
    del proyecto
========================================================================

AppWizard ha creado esta aplicación SocketServer.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la SocketServer aplicación.
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado SocketServer.pch y un archivo de 
